...
public class SettingsFragment extends Fragment {
   ...
   private void initOnClick() {
      ...
      avatarButton.setOnClickListener(view -> {
         ...
         userBasicInfoModel.setAvatar(userSessionViewModel.getAvatar().getValue());
         userBasicInfoModel.setFullname(userSessionViewModel.getFullname().getValue());
         userBasicInfoModel.setId(userSessionViewModel.getAlias().getValue());
