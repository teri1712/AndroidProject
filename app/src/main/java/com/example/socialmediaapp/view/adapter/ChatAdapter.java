...
import com.example.socialmediaapp.layoutviews.items.message.ChatItemView;
...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ItemHolder> {
   ...
   private TreeMap<String, ChatItemView> viewCaches;
   private List<ChatSessionModel> chatSessionModelList;
   private Context context;

   public ChatAdapter(Context context, List<ChatSessionModel> chatSessionModelList, List<RecyclerViewExtra> topViews, List<RecyclerViewExtra> endViews) {
      this.context = context;
      this.chatSessionModelList = chatSessionModelList;
